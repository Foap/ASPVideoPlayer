...
@IBDesignable open class ASPVideoPlayerView: UIView {
    ...
    private func commonInit() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ASPVideoPlayerView.applicationDidEnterBackground), name: Notification.Name.UIApplicationDidEnterBackground, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(ASPVideoPlayerView.applicationWillEnterForeground), name: Notification.Name.UIApplicationWillEnterForeground, object: nil)
    }
